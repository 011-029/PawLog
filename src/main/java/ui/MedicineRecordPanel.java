...
public class MedicineRecordPanel extends Base {
    private final MainFrame mainFrame;
    protected ArrayList<MedicineRecord> records;
    private User user;
    private Pet pet;

    public MedicineRecordPanel(MainFrame mainFrame) {
        super(mainFrame);
    ...
    protected static class MedicineCard extends BaseCard {
